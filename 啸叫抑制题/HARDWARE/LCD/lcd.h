...
#else
	#define LCD_LED PAout(6)  		//LCD背光    		 公用板
#endif
...
//GUI颜色
#define DARKYELLOW       0x4200 //灰黄色
#define DARKBLUE      	 0X01CF	//深蓝色
#define LIGHTBLUE      	 0X7D7C	//浅蓝色**********************************这个是波形的颜色  
...
void LCD_DrawLine_Color(u16 x1, u16 y1, u16 x2, u16 y2, u16 color);							//画线
